...
var ASM_CONSTS = {
  2832758: ($0) => { globalThis.picorubyRefs[$0] = null; },  
 2832798: ($0) => { globalThis.picorubyRefs[$0] = true; },  
 2832838: ($0) => { globalThis.picorubyRefs[$0] = false; },  
 2832879: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2832917: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2832955: ($0, $1, $2) => { const str = UTF8ToString($1, $2); globalThis.picorubyRefs[$0] = str; },  
 2833028: ($0, $1) => { const arr = globalThis.picorubyRefs[$0]; const elem = globalThis.picorubyRefs[$1]; arr.push(elem); delete globalThis.picorubyRefs[$1]; },  
 2833167: ($0, $1, $2) => { const obj = globalThis.picorubyRefs[$0]; const key = UTF8ToString($1); const val = globalThis.picorubyRefs[$2]; obj[key] = val; delete globalThis.picorubyRefs[$2]; }
};
...
var _mrb_funicular_profiler_available = Module['_mrb_funicular_profiler_available'] = makeInvalidEarlyAccess('_mrb_funicular_profiler_available');
var _mrb_funicular_profiler_snapshot = Module['_mrb_funicular_profiler_snapshot'] = makeInvalidEarlyAccess('_mrb_funicular_profiler_snapshot');
var _mrb_funicular_profiler_summary = Module['_mrb_funicular_profiler_summary'] = makeInvalidEarlyAccess('_mrb_funicular_profiler_summary');
var _mrb_funicular_profiler_control = Module['_mrb_funicular_profiler_control'] = makeInvalidEarlyAccess('_mrb_funicular_profiler_control');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['mrb_funicular_profiler_available'] != 'undefined', 'missing Wasm export: mrb_funicular_profiler_available');
  assert(typeof wasmExports['mrb_funicular_profiler_snapshot'] != 'undefined', 'missing Wasm export: mrb_funicular_profiler_snapshot');
  assert(typeof wasmExports['mrb_funicular_profiler_summary'] != 'undefined', 'missing Wasm export: mrb_funicular_profiler_summary');
  assert(typeof wasmExports['mrb_funicular_profiler_control'] != 'undefined', 'missing Wasm export: mrb_funicular_profiler_control');
  ...
  _mrb_funicular_profiler_available = Module['_mrb_funicular_profiler_available'] = createExportWrapper('mrb_funicular_profiler_available', 0);
  _mrb_funicular_profiler_snapshot = Module['_mrb_funicular_profiler_snapshot'] = createExportWrapper('mrb_funicular_profiler_snapshot', 2);
  _mrb_funicular_profiler_summary = Module['_mrb_funicular_profiler_summary'] = createExportWrapper('mrb_funicular_profiler_summary', 0);
  _mrb_funicular_profiler_control = Module['_mrb_funicular_profiler_control'] = createExportWrapper('mrb_funicular_profiler_control', 1);
  ...
  _call_ruby_callback_sync_event = Module['_call_ruby_callback_sync_event'] = createExportWrapper('call_ruby_callback_sync_event', 3);
